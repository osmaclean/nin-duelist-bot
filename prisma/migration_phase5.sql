...
ALTER TABLE "Player" ADD COLUMN "dmEnabled" BOOLEAN NOT NULL DEFAULT true;

-- 2. Season: adicionar coluna endingNotificationSent (aviso 24h)
ALTER TABLE "Season" ADD COLUMN "endingNotificationSent" BOOLEAN NOT NULL DEFAULT false;
